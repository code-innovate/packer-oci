...
```
```
<copy>unzip packer_1.7.2_linux_amd64.zip -d /usr/local/bin</copy>
```
```
<copy>exit</copy>
```
...
- In your terminal window, **type**
  ...
  ```
  <copy>git clone https://github.com/{yourGithubAccount}/packer-oci.git</copy>
  ```
  **NOTE:**  Change **yourGithubAccount** to reflect your github account name.
